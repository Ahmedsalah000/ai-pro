        ...
        methods: {
            ...
            animPreloaderScreen() {
                ...
                const preloaderContent =
                    preloader.querySelector(".preloader-content");
                    ...
                    scrollTrigger: {
                        ...
                        onUpdate: (self) =>
                            (backTopBtnPath.style.strokeDashoffset =
                                backTopBtnPathLength -
                                self.progress * backTopBtnPathLength),
                    },
                });
            },
    ...
    const app = Vue.createApp({
        ...
        data() {
            return {
                ...
                skillsItems: [
                    {
                        imgUrl: "../assets/images/Python.svg.png",
                        title: "Python",
                    },
                    {
        ...
        methods: {
            ...
            getAppTheme() {
                ...
                const storageSavedTheme =
                    localStorage.getItem("nafieSavedTheme"); // Check to see if there a saved theme
            ...
            openNavMenu() {
                ...
                this.$refs.headerNav
                    .querySelector(".desktop-menu-content")
                    .focus();
            },
            ...
            navMenuTabTrap() {
                ...
                document.addEventListener("keyup", (e) => {
                    if (nav.classList.contains("menu-open")) {
                        ...
                        isFirstTabStop =
                            activeEl === firstTabStop ? true : false;
                    }
                });
            },
            ...
            scrollingOptions() {
                ...
                this.isHeaderBig =
                    scrollPosition >= this.startMinimizingHeaderAt
                        ? false
                        : true; // check for current scroll position to toggle the header
        ...
        computed: {
            ...
            experienceChunks() {
                return [
                    ...Array(Math.floor((this.experienceItems.length - 1) / 3)),
                ];
            },
