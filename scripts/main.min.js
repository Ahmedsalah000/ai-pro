!(function () {
        ...
        methods: {
            animPreloaderScreen() {
                ...
                o
                    ? s.forEach((e) => {
                          const t = new Image();
                          (t.onload = a), (t.onerror = a), (t.src = e.src);
                      })
                    : n();
            },
            initAnimation() {
                ...
                gsap.from(e, {
                    ...
                    gsap.set(i, {
                        ...
                        scrollTrigger: {
                            ...
                            onUpdate: (e) =>
                                (i.style.strokeDashoffset = s - e.progress * s),
                        },
                    });
            },
            animStatisticsItems() {
                ...
                e.forEach((e, i) => {
                    const s = 0 === i ? "" : "< +=0.2";
                    t.from(e, { autoAlpha: 0 }, s).from(e, { y: 50 }, "<");
                });
            },
            animSectionTextBox() {
            ...
            animExperienceItemsTimeline() {
                ...
                if (
                    ...
                    const s = document.documentElement.dir,
                        ...
                        l = [
                            ...e.querySelectorAll(".line:nth-of-type(4n + 1)"),
                        ],
                        p = [
                            ...e.querySelectorAll(".line:nth-of-type(4n + 3)"),
                        ],
                        g = [
                            ...e.querySelectorAll(
                    ...
                    i
                        .set(t, { autoAlpha: 1 })
                        .set(l, { clipPath: r.x[n] })
                        .set(p, { clipPath: r.x[a] })
                        .set(g, { clipPath: r.c[n] })
                        .set(m, { clipPath: r.c[a] }),
                        t.forEach((e) => {
                            l.includes(e) || p.includes(e)
                                ? i.to(e, { clipPath: r.x.to })
                                : g.includes(e)
                                ? i
                                      .to(e, { clipPath: r.c.to[n].st1 })
                                      .to(e, { clipPath: r.c.to[n].st2 })
                                      .to(e, { clipPath: r.c.to[n].st3 })
                                : m.includes(e) &&
                                  i
                                      .to(e, { clipPath: r.c.to[a].st1 })
                                      .to(e, { clipPath: r.c.to[a].st2 })
                                      .to(e, { clipPath: r.c.to[a].st3 });
                        }),
                        o.add(i);
                }
                t.length &&
            ...
            animTestimonialsItems() {
                ...
                e.forEach((e, i) => {
                    const s = 0 === i ? "" : "< +=0.2";
                    t.from(e, { autoAlpha: 0 }, s).from(e, { scale: 0.2 }, "<");
                });
            },
            animContactInfo() {
                const e = gsap.utils.toArray(
    ...
    Vue.createApp({
        ...
        data: () => ({
            ...
            isNavMenuOpen: !1,
            navLinks: [
                { url: "#hero", title: { en: "Home", ar: "الرئيسية" } },
                { url: "#about", title: { en: "About", ar: "من أنا" } },
                { url: "#coding", title: { en: "Coding", ar: "مهاراتي" } },
                { url: "#Goals", title: { en: "Goals", ar: "أعمالي" } },
                { url: "#contact", title: { en: "Contact", ar: "اتصل بي" } },
            ],
            skillsType: "",
            skillsItems: [
                { imgUrl: "assets/images/Python.svg.png", title: "Python" },
                { imgUrl: "assets/images/image.PNG", title: "Opencv" },
                { imgUrl: "assets/images/medi.PNG", title: "Mediapipe" },
                {
                    imgUrl: "assets/images/numpy-hd-logo.png",
                    title: "Numpy",
                },
                { imgUrl: "assets/images/matplot.png", title: "matplolib" },
                { imgUrl: "assets/images/cvzone.png", title: "CvZone" },
                { imgUrl: "assets/images/pyauto.jpg", title: "Pyautoui" },
            ],
            toolsItems: [
                { imgUrl: "assets/images/pc.jpg", title: "pycharm" },
                {
                    imgUrl: "assets/images/vs.png",
            ...
            experienceItems: [
                {
                    date: "2021",
                    companyName: { en: "Planning", ar: "" },
                    jobTitle: { en: "2021/09/20", ar: "مطور الواجهة الأمامية" },
                    desc: { en: "", ar: "مراقبة." },
                },
                {
                    date: "2021",
                    companyName: { en: "Analysis.", ar: "شركة فيسبوك" },
                    jobTitle: { en: "2021/10/10", ar: "مطوّر الويب المتكامل" },
                    desc: {
                        en: " ",
                ...
                {
                    date: "2021",
                    companyName: { en: "Design", ar: "شركة انفاتو" },
                    jobTitle: { en: "", ar: "مطور UI/UX" },
                    desc: {
                        en: "2021/11/15",
                ...
                {
                    date: "2021",
                    companyName: { en: "implementation", ar: "شركة جوجل" },
                    jobTitle: { en: "2022/03/15", ar: "مطور الواجهة الأمامية" },
                    desc: {
                        en: "",
                ...
                {
                    date: "2022",
                    companyName: { en: "Documentation.", ar: "شركة فيسبوك" },
                    jobTitle: { en: "2022/01/15", ar: "مطوّر الويب المتكامل" },
                    desc: {
                        en: "",
                        ar: "تعاونت مع الفرق الإبداعية في تطوير وتنفيذ أفكار مبتكرة.",
                    },
                ...
                {
                    date: "2022",
                    companyName: { en: "Testing.", ar: "شركة جوجل" },
                    jobTitle: { en: "2022/05/05", ar: "مطور الواجهة الأمامية" },
                    desc: {
                        en: "",
                        ar: "مراقبة الجوانب الفنية لتطوير الواجهات الأمامية للمشاريع.",
                    },
                ...
                {
                    date: "2022",
                    companyName: { en: "Business model.", ar: "شركة فيسبوك" },
                    jobTitle: { en: "2022/05/20", ar: "مطوّر الويب المتكامل" },
                    desc: {
                        en: " ",
                        ar: "تعاونت مع الفرق الإبداعية في تطوير وتنفيذ أفكار مبتكرة.",
                    },
            ...
            allPortfolioItems: [
                {
                    ...
                    imgUrl: "assets/images/dis1.jpg",
                    title: {
                        en: "we seek to help people with special needs and those who have disabilities in their hands to use pc",
                        ar: "هنا عنوان المشروع 1",
                    },
                    date: { en: "", ar: "أبريل 2021" },
                    desc: {
                ...
                },
                {
                    ...
                    imgUrl: "assets/images/inter.jpg",
                    title: {
                        en: " interactive computer gaming",
                ...
                },
                {
                    ...
                    imgUrl: "assets/images/dis2.PNG",
                    title: {
                        en: "It aims to help people who have atrophy in the muscles and nervous system",
                ...
                },
                {
                    ...
                    imgUrl: "assets/images/normal.jpg",
                    title: {
                        en: "normal person can use it for entretainment",
                ...
                },
                {
                    ...
                    imgUrl: "../assets/images/dis3.jpg",
                    title: {
                        en: "Enabling people with special needs to use the computer to find a job as a programmer, for example",
                ...
                },
                {
                    ...
                    imgUrl: "assets/images/child.jpg",
                    title: {
                        en: "it suitable for children",
            ...
            testimonialsItems: [
                {
                    imgUrl: "assets/images/hazzem.PNG",
                    quoteContent: {
                        en: "",
                    ...
                    quoteAuthor: { en: "Hazzem Ahmed Abdelatif" },
                    jobTitle: { en: "", ar: "مدير المشاريع" },
                ...
                },
                {
                    ...
                    quoteAuthor: { en: "ahmed salah aboshendy" },
                    jobTitle: { en: "Team Leader", ar: "مدير المشاريع" },
                },
                {
                    imgUrl: "assets/images/ataaby.PNG",
                    quoteContent: {
                        en: "",
                        ar: "أنا سعيد حقًا بالعمل مع محمد وأتطلع إلى العمل معه مرة أخرى قريبا. هو بالتأكيد من المطورين الذي يمكنك الوثوق بهم للعمل على مشروعك من البداية إلى النهاية.",
                    },

                    quoteAuthor: { en: "Ahmed maher elataaby" },
                    jobTitle: { en: "", ar: "مدير المشاريع" },

                },
                {
                    imgUrl: "assets/images/ateef.jpeg",
                    quoteContent: {
                        en: "",
                        ar: "أنا سعيد حقًا بالعمل مع محمد وأتطلع إلى العمل معه مرة أخرى قريبا. هو بالتأكيد من المطورين الذي يمكنك الوثوق بهم للعمل على مشروعك من البداية إلى النهاية.",
                    },

                    quoteAuthor: { en: "Ahmed atef"},
                    jobTitle: { en: "", ar: "مدير المشاريع" },
                ...
                {
                    imgUrl: "assets/images/hawary.PNG",
                    quoteContent: {
                        en: "",
                        ar: "أنا سعيد حقًا بالعمل مع محمد وأتطلع إلى العمل معه مرة أخرى قريبا. هو بالتأكيد من المطورين الذي يمكنك الوثوق بهم للعمل على مشروعك من البداية إلى النهاية.",
                    },

                    quoteAuthor: { en: "Ahmed Saber elhawary" },
                    jobTitle: { en: "", ar: "مدير المشاريع" },

                },
                {
                    imgUrl: "assets/images/khadre.PNG",
                    quoteContent: {
                        en: "",
                        ar: "أنا سعيد حقًا بالعمل مع محمد وأتطلع إلى العمل معه مرة أخرى قريبا. هو بالتأكيد من المطورين الذي يمكنك الوثوق بهم للعمل على مشروعك من البداية إلى النهاية.",
                    },
                    quoteAuthor: { en: "Ahmed Elsayed Khadr", ar: "منصور السقاط" },
                    jobTitle: {
                        en: "",
                        ar: "مصمم موشن جرافيك",
                    },
                ...
                {
                    imgUrl: "assets/images/magdy.PNG",
                    quoteContent: {
                        en: "",
                    ...
                    quoteAuthor: { en: "Ahmed Magdy Tawfiq", ar: "عطا بن عاشور" },
                    jobTitle: { en: "", ar: "آرت دايركتور" },
                },
                {
                    imgUrl: "assets/images/saad.jpg",
                    quoteContent: {
                        en: "",
                        ar: "عمل محمد في عدد كبير من المشاريع لأجلنا وكان دائمًا يفوق توقعاتنا. مطور متخصص وموهوب ونسعد دائمًا بالعمل معه.",
                    },
                    quoteAuthor: { en: "Ahmed Saad Mohamed", ar: "نافع حاتم" },
                    jobTitle: { en: "", ar: "مدير مبيعات" },
                },
                {
                    imgUrl: "assets/images/magdy.PNG",
                    quoteContent: {
                    ...
                    quoteAuthor: { en: "Ahmed Magdy Tawfiq", ar: "صدقي الطويل" },
                    jobTitle: { en: "", ar: "أخصائي SEO" },
                },
                // {
                ...
                //     },
                //     quoteAuthor: { en: "Ahmed Maher Elataby", ar: "مجد الكافي" },
                //     jobTitle: { en: "", ar: "مصور فوتوغرافي" },
                // },
                // {
                //     imgUrl: "https://via.placeholder.com/200",
                //     quoteContent: {
        ...
        mounted() {
            window.innerWidth >= 992 &&
                ...
                document
                    .querySelectorAll(".has-ultimate-tooltip")
                    .forEach((e) => {
                        Popper.createPopper(
                            e,
                            e.querySelector(".ultimate-tooltip"),
                            {
                                placement: "top",
                                modifiers: [
                                    {
                ...
                new GLightbox({ autoplayVideos: !1 }),
        ...
        methods: {
                ...
                t &&
                    ...
                    e.addEventListener("click", () => {
                        i.classList.add("cursor-click-effect"),
                            setTimeout(
                                () => i.classList.remove("cursor-click-effect"),
                                200
                            );
                    }));
            },
            getAppTheme() {
                const e = localStorage.getItem("nafieSavedTheme");
                e
                    ? (this.savedTheme = e)
                    : window.matchMedia
                        ...
                        (t = a[0]),
                            ...
                            "Tab" === n.code
                                ? n.shiftKey
                                    ? s && i.focus()
                                    : o && t.focus()
                                : "Escape" === n.code && this.toggleNavMenu();
            ...
            scrollingOptions() {
                ...
                (this.isHeaderBig = !(e >= this.startMinimizingHeaderAt)),
                    (this.isHeaderHidden =
                        e > 100 && e > this.lastScrollPosition),
            ...
            initializeTilt() {
                ...
                e &&
                    VanillaTilt.init(e.querySelectorAll(".portfolio-item"), {
                        max: 8,
                        speed: 400,
                        glare: !0,
                        "max-glare": 0.3,
            ...
            getPortfolioItems() {
                const e = this.allPortfolioItems
                    .filter((e) => {
                        ...
                        if (!i)
                            return (
                                ...
                                e.category === this.currentFilter
                            );
                        if ("cat" === i) {
                            const i = t.get("cat");
                            return (
                                (this.portfolioArchiveName = i),
                                e.category === i
                            );
                        }
                        if ("tools" === i) {
            ...
            contactFormValidation() {
                ...
                let n = {
                    name: { required: !0, minLength: !0 },
                    email: { required: !0, invalid: !0 },
                    phone: { invalid: !0 },
                    message: { required: !0 },
                };
                "" === t.value
                    ...
                    t.value.length > 0 &&
                    t.value.length < t.getAttribute("minlength")
                        ? ((n.name.minLength = !0),
                          this.setNotify({
                              id: "nameMinLength",
                              className: "danger",
                              msg: t
                                  .closest(".control")
                                  .querySelector(".errors-msgs .minLength")
                                  .value,
                          }))
                        : ((n.name.minLength = !1),
                          this.dismissNotify("nameMinLength")),
                    Object.keys(n.name).some((e) => !0 === n.name[e])
                    ...
                    "" === i.value
                        ? ((n.email.required = !0),
                          this.setNotify({
                              ...
                              msg: i
                                  .closest(".control")
                                  .querySelector(".errors-msgs .required")
                                  .value,
                          }))
                        : ((n.email.required = !1),
                    ...
                    Object.keys(n.email).some((e) => !0 === n.email[e])
                    ...
                    Object.keys(n.message).some((e) => !0 === n.message[e])
            ...
            setNotify({ id: e, className: t, msg: i, time: s }) {
                ...
                e
                    ? !this.notifications.some((t) => t.id === e) &&
        ...
        computed: {
            ...
            filteredPortfolioItems() {
                return new URLSearchParams(window.location.search).get("tax")
                    ? this.portfolioItems
            ...
            staggerdelay: {
                mounted(e, t) {
                    [...e.children].forEach((e, i) => {
                        e.setAttribute(
                            "style",
                            `animation-delay: ${(i + 1) * (t.value || 100)}ms`
                        );
                    });
                },
            },
                ...
                mounted(e, t) {
                    e.classList.add("has-tooltip"),
                        e.insertAdjacentHTML(
                            "beforeend",
                            `<div class="custom-tooltip custom-tooltip-${t.value.dir}">${t.value.text}</div>`
                        );
                },
            },
        },
